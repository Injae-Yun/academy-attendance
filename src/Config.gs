...
/**
 * 알림 문구. 등원·하원을 #{구분} 하나로 갈아 끼워 템플릿을 한 벌만 쓴다.
 *
 ...
 */
var MSG_DEFAULT =
  '[#{학원명}🎶]\n\n#{일자} #{학생명} 학생이 #{시각}에 #{구분}하였습니다.🍀';

/** #{구분} 에 들어갈 말. 알림톡 변수값이라 바꿔도 재심사가 필요 없다. */
