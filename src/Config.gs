...
var MSG_DEFAULT_IN = '[#{학원명}] #{학생명} 학생이 #{일자} #{시각}에 등원했습니다.';
var MSG_DEFAULT_OUT = '[#{학원명}] #{학생명} 학생이 #{일자} #{시각}에 하원했습니다.';
